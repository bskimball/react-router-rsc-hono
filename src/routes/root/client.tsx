            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-t-8 border-white pt-12">
              <div className="lg:col-span-2">
                ...
                <p className="font-body text-gray-400 font-medium max-w-sm mb-8">
                  Experimental template demonstrating functional architecture
                  with Hono, React Router, and React Server Components.
                </p>
                <div className="flex gap-4">
                  ...
                  <div className="w-12 h-12 bg-yellow border-2 border-white rounded-tr-3xl" />
                </div>
              </div>
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-24 lg:py-32">
      <div className="bauhaus-card bg-white p-12 lg:p-20 text-center relative overflow-hidden">
        ...
        <h1 className="text-9xl font-display font-bold text-black mb-4 relative z-10">
          {status}
        </h1>
        ...
        <div className="relative z-10">
          <Link
            to="/"
            className="bauhaus-button bauhaus-button-primary text-xl px-10 py-4"
          >
            Return to System
          </Link>
        </div>
