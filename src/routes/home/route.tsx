			...
			<div className="relative z-10">
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
							<div className="order-2 lg:order-1">
								...
								<p className="text-xl text-gray-800 font-body mb-10 max-w-lg border-l-8 border-blue pl-6">
									...
									<strong>React Router 8</strong> for routing, and{" "}
									<strong>React Server Components</strong> for server-first rendering.
								</p>
							...
							{/* Hero Composition */}
							<div className="order-1 lg:order-2 relative h-125 w-full hidden md:block">
								...
								<div className="absolute top-40 left-32 w-0 h-0 border-l-120 border-l-transparent border-r-120 border-r-transparent border-b-200 border-b-blue filter drop-shadow-[12px_12px_0px_#111]" />
				...
				<section className="border-b-4 border-black bg-cream">
					<div className="grid grid-cols-1 md:grid-cols-3 max-w-7xl mx-auto divide-y-4 md:divide-y-0 md:divide-x-4 divide-black border-l-4 border-r-4 border-black my-0">
						<StatBlock value="RSC" label="Server-first rendering" color="yellow" />
						<StatBlock value="100%" label="Type-safe E2E" color="blue" />
						<StatBlock value="Node" label="Hono runtime" color="red" />
					</div>
				</section>
				...
				<section className="py-24 px-6 bg-cream border-b-4 border-black relative overflow-hidden">
					...
					<div className="max-w-7xl mx-auto relative z-10">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							<BauCard
								title="Hono"
								description="Ultra-fast web framework for the server. Lightweight, type-safe middleware architecture that provides a focused foundation."
								shapeType="circle"
								shapeColor="blue"
							/>
							<BauCard
							...
							<BauCard
								title="Server Comps"
								description="Render components on the server, stream HTML, and hydrate the client where interaction demands it."
								shapeType="triangle"
								shapeColor="red"
							/>
						</div>
					...
					<div className="max-w-7xl mx-auto">
						<div className="text-center mb-16">
							<div className="inline-flex justify-center items-center gap-4 mb-6">
								...
								<div className="w-0 h-0 border-l-16 border-l-transparent border-r-16 border-r-transparent border-b-28 border-b-blue" />
							</div>
						...
						// Forward application requests to RSC
						app.use('*', (c) => build(c.req.raw));
				...
				<section className="py-32 px-6 bg-red border-b-4 border-black relative overflow-hidden">
					{/* Abstract shapes */}
					<div className="absolute -right-20 -top-20 w-96 h-96 rounded-full border-32 border-white opacity-20 pointer-events-none" />
					...
					<div className="absolute right-1/4 bottom-0 w-0 h-0 border-l-100 border-l-transparent border-r-100 border-r-transparent border-b-180 border-b-blue filter drop-shadow-[16px_16px_0px_#111] pointer-events-none" />
