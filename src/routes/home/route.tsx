            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1">
                ...
                <h1 className="font-display font-bold text-6xl sm:text-7xl lg:text-8xl leading-none uppercase tracking-tighter mb-8">
                  The <br />
                  <span className="text-white text-shadow-solid">
                    Modern
                  </span>{" "}
                  <br />
                  Stack
                ...
                <p className="text-xl text-gray-800 font-body mb-10 max-w-lg border-l-8 border-blue pl-6">
                  Build highly functional web applications with{" "}
                  <strong>Hono</strong> on the server,{" "}
                  <strong>React Router 7</strong> for routing, and{" "}
                  <strong>React Server Components</strong> for zero-JavaScript
                  rendering.
                </p>
                ...
                <div className="flex flex-wrap gap-6">
                  <Link
                    to="/about"
                    className="bauhaus-button bauhaus-button-primary text-lg"
                  >
                    Start Building
                  </Link>
                  <a
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              ...
              <p className="font-body text-lg text-gray-700 max-w-md border-l-4 border-black pl-4 font-bold">
                A stripped-down, highly functional stack that eliminates
                unnecessary complexity in favor of raw performance.
              </p>
            </div>
        ...
        <section className="py-32 px-6 bg-red border-b-4 border-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 bg-white border-4 border-black p-12 md:p-20 shadow-[16px_16px_0px_0px_#111]">
            ...
            <p className="text-xl text-black font-body mb-10 max-w-lg mx-auto font-medium">
              Embrace constraints. Eliminate bloat. Build software that performs
              beautifully.
            </p>
